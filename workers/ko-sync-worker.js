...
//
// ÄNDERUNG v2.4 (16.09.2026, Thema 3): AI_OUTPUT_STRATEGIES um die fünf
// Options-Strategien (csp_wheel/atmna/weekly_income/cc/collar) erweitert —
// generate_public_recommendations.js (v1.4) und index.html (v513) waren
// bereits erweitert, diese Whitelist wurde dabei übersehen. Live-Fund
// (16.09.2026): GET /public/ai_output/atmna lieferte 404 "Unbekannte oder
// nicht unterstützte Strategie" trotz erfolgreich generiertem nächtlichem
// Digest — der Cache-Check in index.html wich dadurch korrekt (Fail-Open)
// auf einen Live-Call aus, konnte den Cache aber strukturell nie treffen.
// Reine Whitelist-Erweiterung, keine sonstige Änderung an dieser Route
// (Sanitize-Logik bleibt unverändert nicht nötig, s. Kommentar dort).
//
...
// Equity-/KO-Strategien (AI_OUTPUT_STRATEGIES unten) — seit v2.4
// (16.09.2026) auch für die 5 Options-Strategien, s. dortiger Eintrag.
...
// AKTUALISIERT (v2.4, 16.09.2026, Thema 3): um die fuenf Options-Strategien
// erweitert — das war die dritte, uebersehene Stelle desselben Single-
// Source-of-Truth-Musters, das der Kommentar unten schon am 13.09.2026
// explizit vorausgesagt hatte ("bei kuenftiger Erweiterung ... alle drei
// Stellen mitpflegen"). generate_public_recommendations.js (v1.4) und
// index.html (v513) wurden bereits erweitert; DIESE Whitelist hier wurde
// dabei zunaechst uebersehen — Live-Fund: /public/ai_output/atmna lieferte
// "Unbekannte oder nicht unterstuetzte Strategie" trotz erfolgreich
// generiertem Digest, wodurch der Cache-Check in index.html korrekt (Fail-
// Open) auf einen Live-Call auswich, aber eben nie den Cache treffen konnte.
